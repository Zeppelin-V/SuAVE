...
class ImageCreator extends AbstractCreator {
     ...
     */
	public function __construct(StreamWrapperInterface $streamWrapper,DescriptorInterface $descriptor, ImageAdapterInterface  $adapter, $tileSize=256, $tileOverlap=0, $tileFormat='jpg')
    {
